...
(function () {
    ...
    const CARD_DB_STRUCTURE = {
        ...
        top: [
            ...
            "Bearded Vulture", "Golden Eagle", "Phoebus Apollo",
        ...
        bottom: [
            ...
            "Alpine Newt", "Black Trumpet", "Edelweiss", "Gentian",
        ...
        sides: [
            ...
            "Alpine Marmot", "Chamois", "Mountain Hare", "Steinbock",
            "Bee Swarm", "Common Pipistrelle", "Crane Fly",
            "European Wildcat", "Savi's Pipistrelle", "Wild Boar (♀)"
        ]
    };
    ...
    class GameState {
        ...
        initFromGamedatas(gd) {
            ...
            this.initialDeckSize = dynamicTotal;
            this.removedCount = 0;
    ...
    class TrackerUI {
        ...
        _libCat(title, names, db, graveCounts) {
            ...
            for (const baseName of names) {
                ...
                if (copies > 0) {
                    if (copies <= 2) { if (remaining <= 1) colorClass = 'fst-count-low'; }
                    else {
                ...
                const s = this.state;
                const expected = s.totalUniverseSize > 0
                    ? Math.round(copies * (s.initialDeckSize / s.totalUniverseSize) * 10) / 10
                    : copies;
